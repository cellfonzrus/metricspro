...
**Last updated:** 2026-08-17 (item 15 pt27) · **Branch:** `claude/employee-commission-structure-3g5hva` · **PR:** #30 (draft, CI green)
...
| **Item 15 — Pydantic rollout** | 🟡 in progress, incremental (parts 1–27 = 153 endpoints; ~280 remain) |
...
- **Item 15 (Pydantic), continue incrementally.** Done: parts 1–7c (containment/export/auth-ledger
  ...
  **Part 26:** put_expenses, bulk_apply_expenses, upsert_expense_system_line, put_expense_apply_config,
  ...
  Next commcalc candidates (grep 'body: dict'): put_sales_derive_config, put_pos_profile, save_data_source,
  test_proxy, save_report_pull_map, manual_upload_save/reset_mapping, data_source_login_verify,
  live_login_submit/click/input, ma_overview_put_tile/rate, custom_report_defs_save, agency_* (~9). The
