...
const REPORT_TREES: [string, string][] = [
  ['/commcalc/exec', 'commissions'], ['/commcalc/activations', 'commissions'], ['/commcalc/schematic', 'commissions'], ['/commcalc/reports', 'commissions'], ['/commcalc/gp', 'commissions'],
...
export const REPORT_DIRECTORY: [string, string][] = [
  ...
  ['/crm/reports', 'sales'],
  // Commissions & Pay
  ['/commcalc', 'comm'], ['/commcalc/exec', 'comm'], ['/commcalc/exec/mtd', 'comm'], ['/commcalc/activations', 'comm'], ['/commcalc/schematic', 'comm'],
