...
const NOTES: Record<string, string> = {
  ...
  asset_ledger: 'Auto-swept with the Distributor sweep (GET /paygodashboard/DownloadAssetLanding). Manual upload still available.',
...
const FALLBACK_STEPS: Step[] = [
  ...
  { id: 'dlar_rep', label: 'Metrics — Rep KPI', icon: '📊', kind: 'period', endpoint: 'commcalc/upload/dlar_rep', ft: 'dlar_rep',
    source: 'Carrier KPI portal', url: 'https://boostelevatego.com', auto: true,
    report: 'Rep KPI report' },
  { id: 'dlar_store', label: 'Metrics — Store KPI', icon: '🏪', kind: 'period', endpoint: 'commcalc/upload/dlar_store', ft: 'dlar_store',
    source: 'Carrier KPI portal', url: 'https://boostelevatego.com', auto: true,
    report: 'Store / Advocate KPI report' },
  { id: 'hotsheet', label: 'Pricing Hotsheet', icon: '🏷️', kind: 'module', endpoint: 'commcalc/hotsheet/upload', needsDate: true,
    ...
    report: 'Carrier pricing hotsheet (latest version)', note: 'Pick the date it became effective.' },
  ...
  { id: 'asset_ledger', label: 'Asset Ledger', icon: '📒', kind: 'module', endpoint: 'asset/upload',
    ...
    note: 'Auto-swept with the Distributor sweep (GET /paygodashboard/DownloadAssetLanding). Manual upload still available.' },
