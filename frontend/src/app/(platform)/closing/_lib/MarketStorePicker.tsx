...
import { cascadeStores, marketsFromStores, pruneSelectedStores, type StoreOpt } from './market-store-cascade'

export type { StoreOpt } from './market-store-cascade'
 ...
 * dropdowns are checkbox multi-selects, typing filters (never free text, §3b). Used on every closing
 * filter surface in this module — one component, not a per-page reimplementation (dispatch requirement).
 *
