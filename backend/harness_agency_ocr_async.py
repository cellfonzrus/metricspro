...
#
# It was NOT fixed at this call site, because it was never local to this package: the identical bare
# call appeared at four async sites in four modules (commcalc/agency.py, closing/router.py,
# helpdesk/router.py, remediation/router.py), so the right repair was one shared off-loop path for
# metering rather than four hand-patched call sites, and it belonged to whoever owns the billing
# module.
