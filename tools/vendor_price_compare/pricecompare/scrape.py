"""Browser side: log in to a vendor portal, walk its catalog pages, read every product row.
...
than the login form. Placing the order stays with you.

Everything vendor-specific comes from the vendor's block in vendors.json.
"""
