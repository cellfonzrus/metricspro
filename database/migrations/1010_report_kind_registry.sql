...
INSERT INTO commcalc.report_kind (org_id, key, label, what_in_it, recognisable_columns, source_hint, applies_to_pos,
  ...
  ('00000000-0000-0000-0000-000000000001', 'residual_statement', 'Residual report from the carrier', 'The carrier''s monthly residual statement — recurring pay per line or account for the service month.', '{"Residual","Service Month","MDN","Plan","Account"}', 'from the carrier portal', '{}', '{}', 'house', 'residual', 'commission', 'carrier_commission', '{"residual","mdn","account_id"}', '{"Residual"}', '{}', '{}', 40, NULL),
